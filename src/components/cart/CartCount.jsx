  ...
  return (
    <div className="bg-white h-11 flex items-center justify-between px-3 fixed top-0 left-0 right-0 w-full">
      <div className="flex items-center gap-3">
        ...
        >
          <ChevronDoubleLeftIcon className="w-5 h-5 text-slate-900 hover:text-orange-500 duration-200 stroke-[2]" />
        </div>
        <div className="grid items-center">
          <h1 className="text-base font-normal text-slate-900">
            Your Cart{" "}
            <span className="bg-theme-cart text-slate-100 rounded px-1 py-0.5 text-xs">
              ({totalQTY} items)
            </span>
          </h1>
        </div>
