      ...
      <div className="nike-container mb-11">
        ...
        <div className="mt-7">
          <Splide options={slideOptions}>
            {news?.map((val, idx) => (
              <SplideSlide key={idx} className="mb-0.5 ">
                <div className="relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200 min-h-[500px] sm:min-h-[425px]">
